...
import MetaElementAuthors from "./Comp-metaElementAuthors.vue";
import MetaElementContributors from "./Comp-metaElementContributors.vue";
import MetaElementContributorOrgs from "./Comp-metaElementContributorOrgs.vue";
import MetaElementFrameworks from "./Comp-metaElementFrameworks.vue";
...
export default {
  ...
  async setup(props) {
    ...
    if (props['resourceID'] != "") {action.value = "edit"}
    let mode = ref("basic")
    if (props['resourceID'] != "") {mode.value = "advanced"}

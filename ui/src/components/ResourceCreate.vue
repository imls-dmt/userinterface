    ...
    >
      ...
      <div>
        <Form id="metadataForm">
          <button type="button" class="flexiButton" @click="handleSubmission">
          ...
          <button
            type="button"
            class="flexiButton"
            @click="this.mode = 'basic'"
          >
            Switch to basic entry form (<b
              >this will clear any entered information</b
            >)</button
          >&nbsp;

          <button type="button" class="flexiButton" @click="loadDemoResource">
    ...
    >
      ...
      <div>
        <Form id="metadataForm">
          ...
          <div v-for="(group, index) in this.basicMetadataFields" :key="index">
            <div class="form-section-head">{{ group["groupTitle"] }}</div>
    ...
    return {
      ...
      advancedMetadataFields: [
        ...
        },
        {
          ...
          fields: ["access_conditions___license"],
        },
        {
          group: "accessibility",
  ...
  methods: {
    ...
    handleSubmission() {
      ...
      returnObject["subject"] =
        fieldValues["educational_information___subject-datalist"];
      //keywords ================================
      ...
      returnObject["license"] =
        fieldValues["access_conditions___license-datalist"];
      ...
      returnObject["language_primary"] =
        fieldValues["general___language_primary-datalist"];
      // languages secondary ====================
      ...
      returnObject["purpose"] =
        fieldValues["educational_information___purpose-datalist"];
      ...
      returnObject["lr_type"] =
        fieldValues["educational_information___lr_type-datalist"];
      //contributors ============================
      ...
      axios({
        ...
        if (response.data["status"] == "success") {
          ...
          alert(
            "Success, your submission was added to the processing queue with resource ID: " +
      ...
      for (let element in elements) {
        ...
        if (
          ...
          if (elementSub == "submitter_name") {
            ...
            elements[elementID].value =
              resource["author_org"]["name_identifier_type"];
            ...
            for (let index in resource["target_audience"]) {
              this.flexDataListAdd(
                elementKey,
                resource["target_audience"][index]
              );
            }

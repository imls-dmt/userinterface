...
app.config.globalProperties.$apiBase = process.env.VUE_APP_API_BASE || ""; // use of this is depricated in favor of the provide/inject model supported by the App.vue component. This enables the use of injected variables in setup components, a feature not supported for variables defined with app.config.globalProperties.
